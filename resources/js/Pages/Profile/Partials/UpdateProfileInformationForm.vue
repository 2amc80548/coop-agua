    ...
    <FormSection @submitted="updateProfileInformation">
        ...
        <template #form>
            <div v-if="$page.props.jetstream.managesProfilePhotos" class="col-span-6 sm:col-span-4">
                ...
                <SecondaryButton class="mt-2 me-2 bg-gray-200 dark:bg-gray-700 dark:text-gray-200 hover:bg-gray-300 dark:hover:bg-gray-600" type="button" @click.prevent="selectNewPhoto">
                ...
                <SecondaryButton
                    ...
                    type="button"
                    class="mt-2 bg-gray-200 dark:bg-gray-700 dark:text-gray-200 hover:bg-gray-300 dark:hover:bg-gray-600"
                ...
                <div v-if="$page.props.jetstream.hasEmailVerification && user.email_verified_at === null">
                    <p class="text-sm mt-2 text-gray-700 dark:text-gray-300">
                        ...
                        <Link
                            ...
                            method="post"
                            as="button"
                            class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
        ...
        <template #actions>
            <ActionMessage :on="form.recentlySuccessful" class="me-3 text-green-600 dark:text-green-400">
                Guardado.
            </ActionMessage>
